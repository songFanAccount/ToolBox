  ...
  return (
    <Box>
      ...
      <SectionBox title="What ideas are we looking for?" usePageTitle>
        ...
        <PageParagraph 
          text={
            `While the tools do not strictly need to be academic, it must be noted that I, the sole developer of ToolBox, will personally only work on ideas from my uni courses. Therefore, unless the collaboration involves other ideas, the tools in development will be academic.`
          }
        />
      </SectionBox>
